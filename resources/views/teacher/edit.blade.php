       ...
       <div class="card-body">
        <form action="/teacher/{{ $teacher->id }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="teacher_number" name="teacher_number" value="{{ old('teacher_number', $teacher->teacher_number)}}">
            </div>
            <div class="mb-3">
                <label for="name" class="form-label">Name</label>
                <input type="text" class="@error('name') is-invalid @enderror form-control" id="name" name="name" value="{{$teacher->name}}">
               @error('name')
